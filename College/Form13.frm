...
.ActiveConnection = conn
  .CommandText = "SELECT * From Faculty where fac_id='" & Text1.Text & "'"
...
Adodc1.Refresh
DataGrid1.Refresh
Adodc1.RecordSource = "SELECT * From Faculty where fac_id='" & Text1.Text & "'"
conn.Close
End If
End Sub
...
Adodc1.Refresh
DataGrid1.Refresh
Adodc1.RecordSource = "SELECT * From Faculty"
